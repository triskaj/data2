...
%% $GD(\mathcal{D})$, když ji potřebujeme znát. Trik je ve využití
%% $\subset$, které se vyskytuje u výpočtu, nebo-li k výpočtu 

%% \begin {remark}
  
%% \end {remark}
%% Díky němu je vždy potřeba
%% znát pouze předchozí 

%% Definice $\mathcal P_{\mathcal D}$ je sice rekurzivní, ale závisí vždy
%% pouze na menších nám žádný návod nedává a ještě je rekurzivní.
